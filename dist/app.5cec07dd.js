...
var Router = /** @class */function () {
  ...
  Router.prototype.route = function () {
    ...
    // this.routeTable.filter((route) => routePath.indexOf(route.path) >= 0)[0].page.render();
...
var View = /** @class */function () {
  function View(containerId, template) {
    ...
    if (!containerElement) {
      throw "최상위 컨테이너가 없어서 UI를 진행하지 못했습니다.";
    }
        ...
        return __generator(this, function (_d) {
          switch (_d.label) {
            case 0:
              ...
              if (!!this.store.hasFeed) return [3 /*break*/, 2];
...
router.route();
},{"./store":"src/store.ts","./core/router":"src/core/router.ts","./page":"src/page/index.ts"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
